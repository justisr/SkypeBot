...
public class Drama implements Module {
    ...
    private static HashMap<String, String[]> data = new HashMap<String, String[]>() {{
        ...
        put("sites", new String[] {"Reddit", "4chan", "GitHub", "BitBucket", "IRC", "ForgeCraft", "Patreon", "BTW Forums", "GregTech thread", "Google+", "Twitch", "Bukkit Forums", "Trident Forums", "Spigot Forums", "Sponge Forums", "The YouTube comment section"});
